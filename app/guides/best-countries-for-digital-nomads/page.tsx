    ...
    <main className="bg-white text-slate-800">
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-sky-600 px-6 py-20 text-white">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-6 max-w-2xl text-lg text-blue-100">
            ...
            and flexible lifestyles for digital nomads and long-term travellers.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-12">
        <p className="text-lg leading-8 text-slate-700">
          Remote work has changed the way people travel. More professionals are
          now combining work and travel to live abroad, explore new cultures and
          experience a more flexible lifestyle.
        </p>
  ...
  />
      ...
      <section className="mx-auto max-w-4xl px-6 pb-12">
        ...
        <p className="mt-4 leading-7 text-slate-700">
          The best digital nomad destination depends on the lifestyle you want.
          Some travellers prioritise affordability, others want beaches,
